		...
		<>
			...
			<main className="leading-7 [&:not(:first-child)]:mt-6">
				<h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
					From JavaScript to TypeScript: My Journey to Programming
				</h1>
				<div className="pt-4" />
				<div className="my-6">
					<h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Brief History</h2>
				</div>
				<p>
				...
				<div className="pt-4" />
				<div className="my-6">
					<h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0">Conclusion</h2>
				</div>
				<p>
				...
				<div className="pt-2" />
				<div className="my-6">
					<p>A great developer once said;</p>
					<blockquote className="mt-6 border-l-2 pl-6 italic">
						&quot;Learn to code, it&apos;s cheaper than therapy.&quot; - Anonymous
					</blockquote>
				</div>
				<div className="pt-4" />
				<div className="my-6">
