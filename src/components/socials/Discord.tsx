		...
		>
			<div className="flex items-center space-x-3">
				...
				<div className="flex flex-col">
					<p className="font-medium text-neutral-900 dark:text-neutral-100">John</p>
					<p className="text-neutral-600 dark:text-neutral-400">almostjohn</p>
				</div>
			</div>
